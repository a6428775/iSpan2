...
<title>Taplak - Modern Food Recipe Web Template</title>
<!-- STYLE CSS -->
...
<!--  標題下拉選單區-->				<div class="collapse navbar-collapse"
									...
									<ul class="navbar-nav">
										...
										<a class="nav-link dropdown-toggle" href="#" id="navbarDropdown1" role="button" data-toggle="dropdown"
										   aria-haspopup="true" aria-expanded="false">商家22</a>
										...
										<a class="nav-link dropdown-toggle" href="#" id="navbarDropdown2" role="button" data-toggle="dropdown"
											aria-haspopup="true" aria-expanded="false"> 會員資料 </a>
...
<!--//////////////////////////////////////////////////////////////////////  以上為 標題選單區  HOME  RECIPES 那排 -->
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-6 col-md-3">
						<div class="big-bone">
							<a href="#" class="figure-caption"><div class="caption-inner">
									<p>FOOD</p>
									<span>20 Recipes</span>
								</div></a>
							<figure>
								<img src="images/content/food-l.png" alt="food l">
							</figure>
						</div>
						<div class="small-bone">
							<figure>
								<img src="images/content/food-s.png" alt="food s">
							</figure>
							<figure>
								<img src="images/content/food-s2.png" alt="food s">
							</figure>
						</div>
					</div>
					<!-- end col -->
					<div class="col-6 col-md-3">
						<div class="big-bone">
							<a href="#" class="figure-caption"><div class="caption-inner">
									<p>BEVERAGE</p>
									<span>16 Recipes</span>
								</div></a>
							<figure>
								<img src="images/content/beverage-l.png" alt="beverage l">
							</figure>
						</div>
						<div class="small-bone">
							<figure>
								<img src="images/content/beverage-s.png" alt="beverage s">
							</figure>
							<figure>
								<img src="images/content/beverage-s2.png" alt="beverage s">
							</figure>
						</div>
					</div>
					<!-- end col -->
					<div class="col-6 col-md-3">
						<div class="big-bone">
							...
							<figure>
								<img src="images/content/dessert-l.png" alt="dessert l">
							</figure>
						</div>
						<div class="small-bone">
							<figure>
								<img src="images/content/dessert-s.png" alt="dessert s">
							</figure>
							<figure>
								<img src="images/content/dessert-s2.png" alt="dessert s">
							</figure>
						</div>
					</div>
					<!-- end col -->
					<div class="col-6 col-md-3">
						<div class="big-bone">
							...
							<figure>
								<img src="images/content/pudding-l.png" alt="pudding l">
							</figure>
						</div>
						<div class="small-bone">
							<figure>
								<img src="images/content/pudding-s.png" alt="pudding s">
							</figure>
							<figure>
								<img src="images/content/pudding-ss.png" alt="pudding s">
							</figure>
						</div>
					</div>
					<!-- end col -->
				...
				<div class="row">
					<div class="col-6 col-md-3">
						<div class="recipe-thumb">
							<img src="images/content/thumb-1.png" alt="Recipe Image"><a
		...
		<div class="footer-instagram">
			...
			<!-- end ig-btn -->
			<ul class="ig-feed">
				<li><a href="#"><img src="images/content/ig-1.png"
						alt="photo"></a></li>
				<li><a href="#"><img src="images/content/ig-2.png"
						alt="photo"></a></li>
				<li><a href="#"><img src="images/content/ig-3.png"
						alt="photo"></a></li>
				<li><a href="#"><img src="images/content/ig-4.png"
						alt="photo"></a></li>
				<li><a href="#"><img src="images/content/ig-5.png"
						alt="photo"></a></li>
				<li><a href="#"><img src="images/content/ig-6.png"
						alt="photo"></a></li>
			</ul>
		</div>
		...
		<div class="footer-social">
			<div class="container">
				<a href="#"><i class="fab fa-facebook-square"></i>Facebook</a><a
					...
					class="fab fa-linkedin"></i>Linkedin</a><a href="#"><i
			...
			<div class="container">
					...
					<div class="col-md-6">
						<div class="widget widget-subscribe">
							<div class="widget-inner">
								...
								<span>Register your email address to get promos,product
									updates and other info.</span>
				...
				<div class="row no-gutters">
					<div class="col-md-6">
						<div class="copy">
							<p>
								&copy;2020 Taplak Web Template. Made with <i
									class="fas fa-heart"></i>by Mattsapii
							</p>
						</div>
						<!-- end copy -->
					</div>
