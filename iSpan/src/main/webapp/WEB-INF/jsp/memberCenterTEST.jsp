        ...
        $.ajax({
            ...
            success: function(data){  //server送回來的訂單資料
                ...
                if(data==null){
             	   ...
             	   var table = $('#showorder'); 
             	   table.append("<thead><tr id='ptitle' align='center'><th>評論</th><th>No.</th><th>訂單日期</th><th>訂單狀態</th><th>詳細</th></tr></thead>");
									...
									<div class="offset-sm-1 col-md-10">
										...
										$(document).ready( function () {
										    $('#tableAjax').DataTable({
										        ...
										        { data: 'feedback',title: "評論" },
										        { data: 'position',title: "訂單日期"},
										        { data: 'state',title: "訂單狀態" },
										        { data: 'more',title: "詳細" },
										        ]
										});
