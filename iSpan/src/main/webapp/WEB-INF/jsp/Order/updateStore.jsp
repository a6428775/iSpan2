...
//             $('table').prepend('<tr><td colspan="2">No Result</td></tr>');
        	 ...
        	 $('#storeAddress').attr({"value":jsonArray.storeAddress});
        	 $('#storeBusinessHours').attr({"value":jsonArray.storeBusinessHours});
         }
     }
	   });
}
					                ...
					                <div class="row justify-content-center">
					                    <div class="col-lg-8 col-xl-7">
					                        ...
					                        <form id="contactForm"  method="post" enctype="multipart/form-data" action="/Store/insertStoreProduct2.controller">
					                            ...
					                            <!-- Submit Button-->
					                            <button class="btn btn-primary " id="submitButton" type="button" onclick='alertTest()'>送出修改</button>
					                        </form>
					                    </div>
					                </div>
					            </div>
