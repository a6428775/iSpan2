...
if (n>=0){	
	...
	clearCart();
	window.location.href='http://localhost:8081/login/welcome';
}
...
<div style="text-align: center;" id="reciprocal">
<span>3秒後跳轉首頁</span>
</div>

<div class="container">
		<div class="col-md-12 col-md-offset-3" style=font-size:20px>
			...
			<form id="idFormAioCheckOut" method="post" action="ECPayServer" style=display:none class="border shadow p-3 mb-5">	
