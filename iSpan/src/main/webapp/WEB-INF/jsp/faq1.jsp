										...
										<li class="nav-item dropdown"><a
											...
											<div class="dropdown-menu" aria-labelledby="navbarDropdown4">
												<a class="dropdown-item"
													href="/user1/membercenter.controller">登入</a>
												<div class="dropdown-divider"></div>
				...
				<div class="faq-content">
					<div class="row">
						<div class="col-6 col-md-4">
							...
							<h3>什麼是美好食程?</h3>
							<p><strong style="color: red;">美好食程</strong>是一個線上訂餐平台,可以用來預定餐點。</p>
						</div>
						<!-- end col -->
						...
						<div class="col-6 col-md-4">
							<span> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-123" viewBox="0 0 16 16">
